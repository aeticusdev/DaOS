...
void isr_install() {
    set_idt_gate(0, (uint64)isr0);
    set_idt_gate(1, (uint64)isr1);
    set_idt_gate(2, (uint64)isr2);
    set_idt_gate(3, (uint64)isr3);
    set_idt_gate(4, (uint64)isr4);
    set_idt_gate(5, (uint64)isr5);
    set_idt_gate(6, (uint64)isr6);
    set_idt_gate(7, (uint64)isr7);
    set_idt_gate(8, (uint64)isr8);
    set_idt_gate(9, (uint64)isr9);
    set_idt_gate(10, (uint64)isr10);
    set_idt_gate(11, (uint64)isr11);
    set_idt_gate(12, (uint64)isr12);
    set_idt_gate(13, (uint64)isr13);
    set_idt_gate(14, (uint64)isr14);
    set_idt_gate(15, (uint64)isr15);
    set_idt_gate(16, (uint64)isr16);
    set_idt_gate(17, (uint64)isr17);
    set_idt_gate(18, (uint64)isr18);
    set_idt_gate(19, (uint64)isr19);
    set_idt_gate(20, (uint64)isr20);
    set_idt_gate(21, (uint64)isr21);
    set_idt_gate(22, (uint64)isr22);
    set_idt_gate(23, (uint64)isr23);
    set_idt_gate(24, (uint64)isr24);
    set_idt_gate(25, (uint64)isr25);
    set_idt_gate(26, (uint64)isr26);
    set_idt_gate(27, (uint64)isr27);
    set_idt_gate(28, (uint64)isr28);
    set_idt_gate(29, (uint64)isr29);
    set_idt_gate(30, (uint64)isr30);
    set_idt_gate(31, (uint64)isr31);
